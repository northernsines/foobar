...
class Parser:
    ...
    def parse(self) -> Program:
        ...
        # Parse all import statements first (must be at top of file)
        while self.match(TokenType.IMPORT):
            imports.append(self.parse_import())
        
        # Then parse declarations
    ...
    def parse_import(self) -> ImportDecl:
        """Parse an import statement: import "filepath.foob";"""
        self.expect(TokenType.IMPORT)
        
        # Expect string literal for filepath
        filepath_token = self.expect(TokenType.STRING_LITERAL)
        filepath = filepath_token.value
        
        self.expect(TokenType.SEMICOLON)
        
        return ImportDecl(filepath)
